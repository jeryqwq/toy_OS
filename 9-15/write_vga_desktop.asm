...
init_palette:; Function begin
        ...
        push    table_rgb.0                             ; 0085 _ 68, 00000000(d)
...
?_002:  mov     eax, dword [ebp+10H]                    ; 00C7 _ 8B. 45, 10
        ...
        add     dword [ebp-0CH], 1                      ; 011F _ 83. 45, F4, 01
?_003:  mov     eax, dword [ebp-0CH]                    ; 0123 _ 8B. 45, F4
        cmp     eax, dword [ebp+0CH]                    ; 0126 _ 3B. 45, 0C
        jle     ?_002                                   ; 0129 _ 7E, 9C
        sub     esp, 12                                 ; 012B _ 83. EC, 0C
        push    dword [ebp-10H]                         ; 012E _ FF. 75, F0
...
?_004:  mov     eax, dword [ebp+14H]                    ; 0150 _ 8B. 45, 14
        mov     dword [ebp-4H], eax                     ; 0153 _ 89. 45, FC
        jmp     ?_006                                   ; 0156 _ EB, 1F

?_005:  mov     eax, dword [ebp-8H]                     ; 0158 _ 8B. 45, F8
        imul    eax, dword [ebp+0CH]                    ; 015B _ 0F AF. 45, 0C
        mov     edx, eax                                ; 015F _ 89. C2
        mov     eax, dword [ebp-4H]                     ; 0161 _ 8B. 45, FC
...
?_006:  mov     eax, dword [ebp-4H]                     ; 0177 _ 8B. 45, FC
        cmp     eax, dword [ebp+1CH]                    ; 017A _ 3B. 45, 1C
        jle     ?_005                                   ; 017D _ 7E, D9
        add     dword [ebp-8H], 1                       ; 017F _ 83. 45, F8, 01
?_007:  mov     eax, dword [ebp-8H]                     ; 0183 _ 8B. 45, F8
